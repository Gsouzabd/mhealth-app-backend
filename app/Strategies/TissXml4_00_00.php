...
class TissXml4_00_00 implements TissXmlStrategy
{
    ...
    public function gerar(Collection $guias, int $lote): string
    {
        ...
        $cabecalho->addChild('ans:Padrao', '4.00.00');
        ...
        foreach ($guias as $guia){
            ...
            $dadosAtendimento->addChild('ans:coberturaEspecial', $guia->cobertura_especial);
            $dadosAtendimento->addChild('ans:regimeAtendimento', $guia->atendimento_regime);
            $dadosAtendimento->addChild('ans:dataAtendimento', $guia->data);
        ...
        $hashValue = hash('sha256', $xmlContent);
