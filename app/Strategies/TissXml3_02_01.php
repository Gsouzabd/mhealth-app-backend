...
class TissXml3_02_01 implements TissXmlStrategy
{
    ...
    public function gerar(Collection $guias, int $lote): string
    {
        ...
        $cabecalho->addChild('ans:versaoPadrao', '3.02.01');
        ...
        foreach ($guias as $guia){
            ...
            $profissionalExecutante->addChild('ans:conselhoProfissional', ltrim($guia->profissional->conselho->codigo_termo, '0'));
